...
import com.balthazar.ig_now.MainActivity;
import com.balthazar.ig_now.Post;
import com.balthazar.ig_now.R;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        takePicture = view.findViewById(R.id.btnTakePict);
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null) {
                    Log.e(TAG, "Error while saving an image ", e);
                    Toast.makeText(getContext(), "error while saving the image", Toast.LENGTH_SHORT).show();
                }
